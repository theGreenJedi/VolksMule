...
Start with [docs/CANON.md](docs/CANON.md), then read [what the car needs](docs/WHAT_THE_CAR_NEEDS.md), [what rules our SUV has to follow](docs/WHAT_RULES_OUR_SUV_HAS_TO_FOLLOW.md), [what goes in the first Mule](docs/WHAT_GOES_IN_THE_FIRST_MULE.md), and [how big the first Mule should be](docs/HOW_BIG_THE_FIRST_MULE_SHOULD_BE.md). The first integrated packaging bridge is [Revision-A interface envelopes](docs/REV_A_INTERFACE_ENVELOPES.md), with focused follow-on screens for [Revision-A windshield candidates](docs/REV_A_WINDSHIELD_CANDIDATES.md), the [Revision-A READ2982 drive-unit envelope](docs/REV_A_READ2982_ENVELOPE.md), the [Revision-A rear e-axle envelope](docs/REV_A_REAR_EAXLE_ENVELOPE.md), the [Revision-A MIDA EVCC charging-controller envelope](docs/REV_A_MIDA_EVCC_ENVELOPE.md), the [Revision-A steering / EPS envelope](docs/REV_A_STEERING_EPS_ENVELOPE.md), the [Revision-A occupant / manual-seat envelope](docs/REV_A_OCCUPANT_SEAT_ENVELOPE.md), the [Revision-A REPT BEV-cell envelope](docs/REV_A_REPT_CELL_ENVELOPE.md), the [Revision-A BMS physical envelope](docs/REV_A_BMS_PHYSICAL_ENVELOPE.md), the [Revision-A J3400 vehicle-inlet envelope](docs/REV_A_J3400_INLET_ENVELOPE.md), the [Revision-A thermal / HVAC packaging envelope](docs/REV_A_THERMAL_PACKAGING_ENVELOPE.md), the [Revision-A brake-corner envelope](docs/REV_A_BRAKE_CORNER_ENVELOPE.md), the [Revision-A transparent BDU / PDU envelope](docs/REV_A_BDU_PDU_ENVELOPE.md), and the [soft wheel-end service standard](docs/WHEEL_END_SERVICE_STANDARD.md).

The working Phase-8 control document is the [Prototype-1 roadmap sourcing BOM skeleton](docs/ROADMAP_SOURCING_BOM.md). It consolidates each major subsystem's BUY / DONOR / ADAPT / DESIGN strategy, preferred China/Alibaba path, local alternate, selection blocker and service/safety gate.

Alibaba/Chinese-supplier work is split deliberately: broad catalog archaeology is closed, but **roadmap-driven part sourcing remains active**. For a new chat/session, start with the [Alibaba sourcing mission handoff](docs/ALIBABA_MISSION_HANDOFF.md). Then see the clarified [Alibaba sourcing boundary](docs/ALIBABA_SOURCE_MISSION_CLOSEOUT.md), the working [Alibaba sourcing ledger](docs/ALIBABA_SOURCING.md), the [coverage audit](docs/ALIBABA_COVERAGE_AUDIT.md), the current [procurement queue](docs/ALIBABA_PROCUREMENT_QUEUE.md), and the [Wave-1 supplier RFQ packet](docs/ALIBABA_RFQ_WAVE1.md). Current roadmap continuation files include the [Phase-5 roll/steer/stop chassis candidate screen](docs/ALIBABA_PHASE5_CHASSIS_CANDIDATES.md), the [steering-column / intermediate-shaft screen](docs/ALIBABA_STEERING_COLUMN_INTERMEDIATE.md), the [mechanical parking-brake screen](docs/ALIBABA_MECHANICAL_PARKING_BRAKE.md), the [Phase-6 CV / halfshaft / wheel-speed support screen](docs/ALIBABA_PHASE6_DRIVE_SUPPORT.md), the [Phase-7 12-V service-hardware screen](docs/ALIBABA_PHASE7_12V_SERVICE_HARDWARE.md), the [thermal-auxiliary pump / valve / fan screen](docs/ALIBABA_THERMAL_AUXILIARIES.md), the [conventional hydraulic brake-assist screen](docs/ALIBABA_BRAKE_ASSIST.md), the [body-service hardware screen](docs/ALIBABA_BODY_SERVICE_HARDWARE.md), the [manual-seat hardware screen](docs/ALIBABA_MANUAL_SEAT_HARDWARE.md), the [seals / closure-service hardware screen](docs/ALIBABA_SEALS_CLOSURE_SERVICE.md), the [cargo / utility hardware screen](docs/ALIBABA_CARGO_UTILITY_HARDWARE.md), the [physical HVAC controls screen](docs/ALIBABA_PHYSICAL_HVAC_CONTROLS.md), the [underbody protection screen](docs/ALIBABA_UNDERBODY_PROTECTION.md), the [side / rear glazing screen](docs/ALIBABA_SIDE_REAR_GLAZING.md), and the [simple cabin HVAC-box screen](docs/ALIBABA_CABIN_HVAC_BOX.md).
